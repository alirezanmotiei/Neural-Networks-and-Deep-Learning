...
\begin{itemize}
    \item Reconstruction fidelity: SSIM $= 0.871$, PSNR $= 28.4\text{ dB}$, MSE $= 0.012$.
    ...
    \item Downstream Detection: Training a lightweight classification probe on the frozen $32$-dimensional latent embeddings yields $91.3\%$ sensitivity for polyp presence.
\end{itemize}
