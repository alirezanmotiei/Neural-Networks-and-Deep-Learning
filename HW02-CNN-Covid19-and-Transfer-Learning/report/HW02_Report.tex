...
\begin{itemize}
    \item COVID-19 Class: Precision $98.39\%$, Recall $98.04\%$, F1-Score $98.21\%$.
    \item Normal Class: Precision $93.93\%$, Recall $93.43\%$, F1-Score $93.68\%$.
    \item Viral Pneumonia: Precision $94.54\%$, Recall $95.38\%$, F1-Score $94.96\%$.
\end{itemize}
...
\midrule
Scratch CNN (Baseline) & $88.5$ & $50.71$ & \textbf{4.2} \\
VGG-16 Feature Extractor & $92.1$ & $60.92$ & $12.8$ \\
VGG-16 + SVM Classifier & $95.4$ & $66.17$ & $13.1$ \\
\textbf{VGG-16 + Fine-Tuning} & \textbf{97.6} & \textbf{72.36} & $14.5$ \\
\bottomrule
\end{tabular}
\label{tab:vgg_svm}
\end{table}
