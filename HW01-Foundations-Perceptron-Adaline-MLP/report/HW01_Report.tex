...
As depicted in Fig.~\ref{fig:fraud_pr}, the network achieves an accuracy of $94.93\%$, precision of $100.0\%$, recall of $89.86\%$, and F1-score of $94.66\%$, providing robust fraud discrimination without overwhelming financial operations with false alarms.
...
\end{equation}
The 64-dimensional bottleneck features allow the linear classifier to reach $81.50\%$ test accuracy ($75.97\%$ for 16-dimensional bottleneck), confirming that unsupervised reconstruction forces the latent space to capture semantic morphological invariants of digits.
