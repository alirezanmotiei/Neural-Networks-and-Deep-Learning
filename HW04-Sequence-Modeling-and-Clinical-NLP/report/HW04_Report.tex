...
\end{equation}
Our trained ResNet-50 + LSTM system achieves under Beam Search ($k=5$):
\begin{itemize}
    \item BLEU-1: $0.2139$ (Greedy: $0.1389$)
    \item BLEU-2: $0.3218$ (Greedy: $0.2193$)
    \item BLEU-3: $0.3798$ (Greedy: $0.2569$)
    \item BLEU-4: $0.4152$ (Greedy: $0.2783$)
\end{itemize}
