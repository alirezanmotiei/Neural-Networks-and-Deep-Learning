...
\midrule
Standard CNN & $4.8\text{M}$ & $0.285$ & $90.0$ & $0.900$ \\
\textbf{Vision Transformer (ViT)} & $8.6\text{M}$ & \textbf{0.142} & \textbf{97.0} & \textbf{0.970} \\
\bottomrule
\end{tabular}
